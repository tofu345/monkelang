...
repl: .FORCE
	@ gcc ${CFLAGS} -o build/repl.out \
		main.c repl.c lexer.c token.c parser.c buffer.c \
...
test_parser: .FORCE
	@ gcc ${CFLAGS} -o build/test_parser.out \
		unity/* test_parser.c buffer.c parser.c parser_tracing.c \
		ast.c lexer.c token.c

test_ast: .FORCE
	@ gcc ${CFLAGS} -o build/test_ast.out \
		unity/* test_ast.c ast.c token.c buffer.c

test_evaluator: .FORCE
	@ gcc ${CFLAGS} -o build/test_evaluator.out \
		unity/* test_evaluator.c evaluator.c object.c buffer.c \
